...
android {
    namespace = "com.fmhub24.extensions.moviebox"
    compileSdk = 36
...
cloudstream {
    ...
    iconUrl = "https://raw.githubusercontent.com/NivinCNC/CNCVerse-Cloud-Stream-Extension/refs/heads/master/MovieBoxProvider/icon.png"
